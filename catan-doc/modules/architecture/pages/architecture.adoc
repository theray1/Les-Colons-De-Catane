...
[plantuml]
----
include::sequenceDiagram_Protocols.plantuml[]
----

Coté client, [PARTIE POUR LE RAY ERWAN]

.Exemple d'un diagramme de déploiement (niveau spécification)
[plantuml]
----
include::deploymentDiagram.plantuml[]
----

.Exemple d'un diagramme de déploiement (niveau instance)
[plantuml]
----
include::deploymentDiagramInstance.plantuml[]
----
