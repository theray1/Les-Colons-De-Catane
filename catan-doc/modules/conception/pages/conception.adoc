...
(voir command pattern plus bas). Le client et le serveur doivent savoir quel class instancier
a la reception d'une commande. On ajoute un parameter "type" dans la commande serialize
et definitions un mapping commun entre le client serveur.
