...
Ainsi le client (le joueur), lorsque c'est à lui de jouer peut emmetre des commandes et ainsi communiquer avec le serveur.
Chaque commande à une implémentation (un comportement présci) et cela permet au server de savoir quoi faire.
