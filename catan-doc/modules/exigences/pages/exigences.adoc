...
.connexion
include::partial$uc-connection.adoc[]
...
==== Description sous la forme d'un cas d'utilisation
.uc-createGame
include::partial$uc-createGame.adoc[]
...
.uc-gameJoin
include::partial$uc-gameJoin.adoc[]
...
==== Description sous la forme d'un cas d'utilisation
.uc-initGame
include::partial$uc-initGame.adoc
...
==== Description sous la forme d'un cas d'utilisation
.uc-startGame
include::partial$uc-startGame.adoc
...
==== Description sous la forme d'un cas d'utilisation
.uc-playTurn
include::partial$uc-playTurn.adoc
